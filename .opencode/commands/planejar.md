...
2. `AGENTS.md`.
3. `.opencode/commands/executar-tarefa.md` e `.opencode/commands/executar-plano.md`.
...
6. Um commit — mensagem pelo guia § Convenções de Git › Commit.
7. Mostre arquivos e resultado da conferência; pergunte se abre o PR.
8. Autorizado → `git push -u origin <branch>`; PR — guia § Convenções de Git › PR —, label
