...
| `src/components/Estatisticas.jsx` | Vista interna de estatísticas da coleção, sem router: cinco blocos (resumo, progresso por grupo e por seção, repetidas por seção e histograma) derivados da coleção em memória, somente leitura, com gráficos à mão em SVG/CSS (ver [IDR 0072](docs/idr/0072-pagina-de-estatisticas-como-vista-interna.md) e [TDR 0030](docs/tdr/0030-graficos-de-estatisticas-a-mao-sem-biblioteca.md)). |
