...
| `docs/interface.md` | Decisões de interface (o "como" da UI: telas, faixas de tela, identidade visual, interações). Esqueleto até a fase de implementação; em conflito com requisitos, requisitos vence. |
