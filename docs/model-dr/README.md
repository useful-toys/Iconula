...
| [MDR 0006](0006-catalogo-estatico-embutido.md) | Catálogo estático embutido | Aceito | catalogo, dados | 50 seções, 994 figurinhas expandidas por função pura, com `nome` e `nomeLinhas`; FWC `inicio: 0`, seleções `inicio: 1`; paisagem na 13 das seleções e em FWC00–03 e 09–19. |
