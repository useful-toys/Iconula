...
- **Fonte**: fornecimento do humano (fonte original do álbum), conferido na Tarefa 0017-0001 contra o checklist de defeitos da primeira listagem. COC01–COC14 e FWC00–FWC19 foram reenviados e confirmados em 2026-09-13, idênticos à provisão anterior. A divergência FWC10–19 se resolveu em favor da fonte: FWC09 é a Taça Jules Rimet (FIFA Museum) e FWC10–19 são dez pôsteres históricos de campeãs, de Uruguai 1950 a Argentina 2022 — a descrição "onze campeãs históricas, de Itália 1934 a 2022" na seção da Fase 14 do README do plano era imprecisa e foi corrigida.
- **Grafia**: na transcrição, correções óbvias e diacritics dos nomes de imprensa conhecida (ex.: Matt Freese, Édouard Mendy, Çağlar Soyuncü, José Sá, Rúben Dias, João Félix, Uğurcan Çakır, Hakan Çalhanoğlu, Sadio Mané, Joško Gvardiol); nomes não reconhecidos são confirmados com o humano antes de entrar — confirmados em 2026-09-13: Orlando Gill (PAR 2) e Van Valery (TUN 3), como escritos.
