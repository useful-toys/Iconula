...
- **Fonte**: fornecimento do humano (fonte original do álbum), conferido na Tarefa 0017-0001 contra o checklist de defeitos da primeira listagem. FWC e COC aguardam reenvio; até lá, valem as listas da provisão anterior (registradas no Histórico do [IDR 0047](../idr/0047-nomes-de-jogadores-nas-figurinhas.md)), com a divergência FWC10–19 (pôsteres × "campeãs históricas do FIFA Museum, 1934–2022" da Fase 14) a resolver no reenvio.
