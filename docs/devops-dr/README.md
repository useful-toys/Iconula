...
| [DDR 0007](0007-ciclo-de-vida-dos-canais-de-preview.md) | Ciclo de vida dos canais de preview | Aceito | deploy, ci | Naming explícito (`pr<N>`), expiração de 3 dias, cleanup automático ao fechar, restrição a PRs do próprio repositório; host do canal autorizado no Firebase Auth enquanto o canal existir. |
