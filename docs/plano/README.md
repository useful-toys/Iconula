...
| 31 | [Exclusão de dados e conformidade da política](0031-exclusao-de-dados-e-conformidade-da-politica/) | Apagar coleção e conta pelo app e completar a política com controlador, base legal, transferência e retenção | — | `feat: apagar meus dados e política de privacidade conforme a LGPD` | Em andamento |
