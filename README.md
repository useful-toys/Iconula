...
[docs/model-dr](docs/model-dr), as decisões de DevOps em
...
reproduzir) em [docs/setup-firebase.md](docs/setup-firebase.md),
[docs/setup-gcloud.md](docs/setup-gcloud.md) e
